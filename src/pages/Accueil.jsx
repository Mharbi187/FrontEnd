...
const Accueil = () => {
  ...
  const feature3 =
    "https://images.unsplash.com/photo-1526628953301-3e589a6a8b74?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=600&h=400&q=80";
      ...
      <section className="relative py-20 md:py-32 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-600 to-blue-800 text-white overflow-hidden">
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          <p className="text-xl md:text-2xl max-w-3xl mx-auto mb-8">
            La solution tout-en-un pour simplifier votre supply chain et booster
            votre productivité
          </p>
            ...
            {[
              {
                ...
                description:
                  "Visualisez vos opérations logistiques en temps réel sur un tableau de bord unifié.",
              ...
              },
              {
                ...
                description:
                  "Découvrez des insights puissants pour optimiser vos coûts et performances.",
              ...
              },
              {
                ...
                description:
                  "Automatisez vos processus répétitifs et concentrez-vous sur votre cœur de métier.",
            ...
            {[
              {
                ...
                quote:
                  "Livrini a transformé notre gestion logistique. Nous avons réduit nos coûts de 30% en 3 mois !",
                date: "15 Mars 2023",
                photo: client1,
              },
              {
                ...
                quote:
                  "L'interface intuitive et les fonctionnalités puissantes nous font gagner plusieurs heures par jour.",
                date: "2 Avril 2023",
                photo: client2,
              },
              {
                ...
                quote:
                  "La solution la plus complète que nous ayons testée. Le support technique est exceptionnel !",
                date: "10 Mai 2023",
                photo: client3,
              },
            ].map((testimonial, i) => (
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-600 to-blue-800 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl mb-8">
            Rejoignez les centaines d'entreprises qui optimisent déjà leurs
            opérations avec Livrini.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link
              to="/register"
